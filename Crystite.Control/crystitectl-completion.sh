...
declare -A _CRYSTITECTL_VERB_TYPES=(
...
declare -a _CRYSTITECTL_GLOBALUSER_OPTS=("--name" "--id")
declare -a _CRYSTITECTL_WORLD_OPTS=("--name" "--id")
declare -a _CRYSTITECTL_WORLDUSER_OPTS=("--name" "--id" "--user-id" "--user-name")

declare -A _CRYSTITECTL_VERB_OPTS=(
  ["General"]=""
...
declare -a _CRYSTITECTL_COMMON_OPTS=(
  "--port"
  "--server"
  "--output-format"
)

declare -a _CRYSTITECTL_SET_ROLE_FLAGS=("--role")
declare -a _CRYSTITECTL_MODIFY_WORLD_FLAGS=("--new-name" "--description" "--access-level" "--away-kick-interval" "--hide-from-listing" "--max-users")
declare -a _CRYSTITECTL_START_WORLD_FLAGS=("--template" "--url")
declare -A _CRYSTITECTL_VERB_FLAGS=(
...
declare -a _CRYSTITECTL_OUTPUT_FORMAT_VALUES=("Simple" "Verbose" "Json")
declare -a _CRYSTITECTL_ROLE_VALUES=("Admin" "Builder" "Moderator" "Guest")
declare -a _CRYSTITECTL_ACCESS_LEVEL_VALUES=("Private" "LAN" "Contacts" "ContactsPlus" "RegisteredUsers" "Anyone")
declare -A _CRYSTITECTL_CRYSTITECTL_FLAG_VALUES=(
